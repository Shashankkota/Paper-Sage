...
const loadingMessages = [
  ...
  "Evaluating abstract and introduction...",
  "Analyzing methods and results...",
  "Checking for plagiarism and originality...",
  "Verifying citations...",
  "Compiling feedback and suggestions...",
  "Finalizing your review report..."
];
...
export const Loader: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center">
      ...
      <h3 className="mt-4 text-lg font-semibold text-gray-700">Analyzing Your Paper</h3>
